...
function createBaseNodeMetadata(): NodeMetadata {
  return { grpcPort: 0, weight: 0 };
}

export const NodeMetadata: MessageFns<NodeMetadata> = {
  ...
  create<I extends Exact<DeepPartial<NodeMetadata>, I>>(base?: I): NodeMetadata {
    return NodeMetadata.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<NodeMetadata>, I>>(object: I): NodeMetadata {
    const message = createBaseNodeMetadata();
